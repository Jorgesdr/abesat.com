    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              Especialistas en accidentes de tráfico en Granada. Garantizamos la máxima indemnización para nuestros clientes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/nosotros" className="text-gray-300 hover:text-white transition-colors">Sobre nosotros</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} ABESAT - Abogados Accidentes de Tráfico Granada. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
