...
export const metadata = {
  ...
  description:
    "Abogados especialistas en accidentes de tráfico en Granada. Reclamaciones, indemnizaciones y defensa penal. Consulta gratuita.",
}
      ...
      <section className="bg-background-blues relative py-20 ">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Abogados Accidentes Tráfico Granada ⭐ Especialistas en
              Indemnizaciones
            </h1>
            {/* <p className="text-xl mb-8">
              En ABESAT Abogados somos especialistas en accidentes de tráfico en
              Granada. Luchamos por tus derechos con un equipo experto en
              reclamaciones e indemnizaciones. Confía en abogados de accidentes
              tráfico Granada con más de 15 años de experiencia.
            </p> */}
            <p className="text-xl mb-8">
              ABOGADOS ESPECIALISTAS en accidentes de tráfico en GRANADA. ⭐
              Reclamamos tu INDEMNIZACIÓN MÁXIMA. Consulta GRATUITA. +15 años
              experiencia. Asistencia 24h.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                ...
                className="bbg-transparent dark:border-white border-2 dark:text-white hover:bg-gray-300 hover:text-blue px-6 py-3 rounded-lg font-medium inline-block w-full text-center"
              >
      ...
      <section className="py-16 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Servicios de Abogados para Accidentes de Tráfico en Granada
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                en accidentes de coche, moto o atropellos.
              </p>
              <Link
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Defensa legal para víctimas con lesiones graves, incapacidades
                permanentes o grandes invalideces.
              </p>
              <Link
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Asistencia legal en procedimientos penales derivados de
                accidentes con víctimas o daños.
              </p>
              <Link
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Conocemos a la perfección los juzgados y compañías de
                      seguros de Granada.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Luchamos por conseguir la mayor compensación posible por
                      tu accidente.
                    </p>
                  </div>
                </li>
      ...
      <section className="bg-primary-600 text-gray-600 dark:text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            ¿Buscas abogados accidentes tráfico Granada?
          </h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Contacta ahora con nuestro equipo de abogados especializados en
            accidentes de tráfico en Granada. Te ayudamos a reclamar la
