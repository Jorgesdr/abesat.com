...
export const metadata = {
  ...
  description:
    "Especialistas en reclamación de indemnizaciones por accidentes de tráfico en Granada",
}
            ...
            <div className="lg:w-2/3">
              ...
              <div className="prose max-w-none">
                <p className="text-lg mb-4">
                  En ABESAT Abogados somos especialistas en reclamación de
                  indemnizaciones por accidentes de tráfico. Nuestro equipo
                  jurídico cuenta con amplia experiencia en la valoración y
                  reclamación de todos los conceptos indemnizatorios reconocidos
                  por la ley.
                </p>
                ...
                <p className="mb-4">
                  ...
                  los aspectos médicos, jurídicos y económicos para conseguir la
              ...
              <div className="mt-12 p-6 bg-primary-50 rounded-lg text-center">
                <h3 className="text-xl font-semibold mb-4">
                  ¿Quiere saber cuánto le corresponde?
                </h3>
                <p className="mb-4">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      <Link
                        ...
                        className="text-primary-600 hover:underline"
                      >
                        Accidentes de Tráfico en Granada
                      </Link>
                    </li>
                  </ul>
                </div>
            ...
            {[
              {
                ...
                answer:
                  "El plazo general es de 1 año desde el accidente, pero recomendamos iniciar el proceso lo antes posible.",
              },
              {
                question: "¿Cómo se calcula el importe de la indemnización?",
                answer:
                  "Se valora según baremos legales que consideran la gravedad de las lesiones, días de curación y secuelas.",
              },
              {
                question: "¿Tengo que pagar si no gano el caso?",
                answer:
                  "Trabajamos a éxito, solo cobramos honorarios si conseguimos su indemnización.",
              },
            ].map((item, index) => (
